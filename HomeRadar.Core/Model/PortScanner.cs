// <copyright file="PortScanner.cs" company="FutureInnovationTech">
...
namespace HomeRadar.Core.Model
{
    ...
    public class PortScanner
    {
        ...
        public static async Task RunPortScanAsync()
        {
            ...
            PortScan cps = new PortScan("127.0.0.1", 75, 85);

            var progress = new Progress<PortScan.PortScanResult>();
    ...
    internal class PortScan
    {
        ...
        public PortScan(string host, int minPort, int maxPort)
        {
            if (minPort > maxPort)
